          ...
          <div class="pushright">
           <div class="top">
             ...
             <div class="col-md-6">
              ...
              <p>
                Yeni Kullanıcı mısın? Daha güvenli ve bilgilerine istediğin zaman ulaşmak için hemen kayıt olmalısın!
              </p>
...
<div class="main-nav"><!--end main-nav -->
 <div class="navbar navbar-default navbar-static-top">
  ...
  <div class="col-md-2 machart">
   <button id="popcart" class="btn btn-default btn-chart btn-sm "><span class="mychart">Bilet Tutarı</span>|<span class="allprice">0.00 TL</span></button>
   <div class="popcart">
    <table class="table table-condensed popcart-inner">
     <tbody>
      ...
      while($sepetcek=$sepetsor->fetch(PDO::FETCH_ASSOC)) {
        ...
        <td><a href="product.htm"><?php echo $uruncek['ucak_marka'] ?></a></td>
        <td><?php echo $sepetcek['bilet_adet'] ?> Adet</td>
  ...
  <div class="btn-popcart">
   <a href="sepet" class="btn btn-default btn-red btn-sm">Fiyatı Görüntüle</a>
 </div>
...
<ul class="small-menu">
  ...
  <li><a href="siparislerim" class="fa fa-plane">Biletlerim</a></li>
  <li><a href="logout" class="fa fa-plane">Güvenli Çıkış</a></li>
</ul>
