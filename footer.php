		...
		<div class="container">
			<div class="row">
				<div class="col-md-4"><!--footer twitter widget-->
					...
					<ul class="tweets">				
						<li class="lastone">Twitter sayfamıza göz atınız. <br> <a href="#">http://t.co/LbLwldb6 </a>
				...
				<div class="col-md-4"><!--footer newsletter widget-->
						...
						<div class="title-widget">SKYSEE</div>
					
					<div class="newsletter">
						<p>
							Tek amacımız, siz değerli müşterilerimize 7 / 24 kesintisiz kalitede hizmet verebilmektir. Bizi tercih ettiğiniz için teşekkürler.
						</p>
				...
				<div class="col-md-4"><!--footer contact widget-->
						...
						<div class="title-widget-cursive">Biletler</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3"><!--footer Share-->
					<div class="followon">Bizi takip etmeyi unutmayın</div>
					<div class="fsoc">
						...
						<a href="http://<?php echo $ayarcek['ayar_instagram']; ?>" class="ffeed">Google</a>
