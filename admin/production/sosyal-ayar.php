              ...
              <div class="x_content">
                ...
                <form action="../baglanti/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="first-name" placeholder="Google adresinizi giriniz..." name="ayar_instagram" value="<?php echo $ayarcek['ayar_instagram']; ?>" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>                    
