                  ...
                  <div class="x_panel">
                    <div class="x_title">
                      ...
                      <div align="right" class="col-md-9">
                        ...
                        <a class="btn btn-success" href="urun-galeri.php?ucak_id=<?php echo $_GET['ucak_id'];?>"><i class="fa fa-plus" aria-hidden="true"></i> Yüklenen Resimleri Gör</a>
                      </div>
                    ...
                    <div class="x_content">
                      ...
                      <form action="../baglanti/urungaleri.php" class="dropzone" >
